...
(function () {
  ...
  <div flow="down">
    ...
    padding: 5px">
      ...
      <option value="fade-in-05">Fade/d 0.5s</option>
      <option value="fade-in-10">Fade/d 1.0s</option>
      <option value="fade-in-15">Fade/d 1.5s</option>
      <option value="fade-in-20">Fade/d 2.0s</option>
      <option value="fade-in-25">Fade/d 2.5s</option>
      <option value="fade-in-30">Fade/d 3.0s</option>
      <option value="fade-in-35">Fade/d 3.5s</option>
      <option value="fade-in-40">Fade/d 4.0s</option>
      <option value="none">---------------</option>
      <option value="scale-in-center-05">Scale/d 0.5s</option>
      <option value="scale-in-center-10">Scale/d 1.0s</option>
      <option value="scale-in-center-15">Scale/d 1.5s</option>
      <option value="scale-in-center-20">Scale/d 2.0s</option>
      <option value="scale-in-center-30">Scale/d 3.0s</option>
      <option value="scale-in-center-40">Scale/d 4.0s</option>
      <option value="none">---------------</option>
      <option value="tilt-in-top-V-08">T-top-V/d 0.8s</option>
      <option value="tilt-in-top-V-15">T-top-V/d 1.5s</option>
      <option value="tilt-in-top-V-25">T-top-V/d 2.5s</option>
      <option value="tilt-in-top-V-35">T-top-V/d 3.5s</option>
      <option value="none">---------------</option>
      <option value="tilt-in-top-H-08">T-top-H/d 0.8s</option>
      <option value="tilt-in-top-H-15">T-top-H/d 1.5s</option>
      <option value="tilt-in-top-H-25">T-top-H/d 2.5s</option>
      <option value="tilt-in-top-H-35">T-top-H/d 3.5s</option>
      <option value="none">---------------</option>
      <option value="tilt-in-bottom-V">Tilt-V/d 0.8s</option>
      <option value="tilt-in-bottom-V-15">Tilt-V/d 1.5s</option>
      <option value="tilt-in-bottom-V-20">Tilt-V/d 2.0s</option>
      <option value="tilt-in-bottom-V-30">Tilt-V/d 3.0s</option>
      <option value="tilt-in-bottom-V-40">Tilt-V/d 4.0s</option>
      <option value="none">---------------</option>
      <option value="tilt-in-bottom-H">Tilt-H/d 0.8s</option>
      <option value="tilt-in-bottom-H-15">Tilt-H/d 1.5s</option>
      <option value="tilt-in-bottom-H-20">Tilt-H/d 2.0s</option>
      <option value="tilt-in-bottom-H-30">Tilt-H/d 3.0s</option>
      <option value="tilt-in-bottom-H-40">Tilt-H/d 4.0s</option>
      <option value="none">---------------</option>
