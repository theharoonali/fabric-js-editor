...
(function () {
  ...
  <div flow="down">
    ...
    padding: 5px">
      ...
      <option value="none">---------------</option>
      <option value="0.5" data-attribute="SlideinLeft">Slide V/d 0.5s</option>
      <option value="1.5" data-attribute="SlideinLeft">Slide V/d 1.5s</option>
      <option value="2.5" data-attribute="SlideinLeft">Slide V/d 2.5s</option>
      <option value="3.5" data-attribute="SlideinLeft">Slide V/d 3.5s</option>
      <option value="4.5" data-attribute="SlideinLeft">Slide V/d 4.5s</option>
    
      <option value="none">---------------</option>
      <option value="0.5" data-attribute="SlideinRight">Slide H/d 0.5s</option>
      <option value="1.5" data-attribute="SlideinRight">Slide H/d 1.5s</option>
      <option value="2.5" data-attribute="SlideinRight">Slide H/d 2.5s</option>
      <option value="3.5" data-attribute="SlideinRight">Slide H/d 3.5s</option>
      <option value="4.5" data-attribute="SlideinRight">Slide H/d 4.5s</option>
      
    </select>
  </div>`;
  // <option value="none">---------------</option>
  //     <option value="swing-in-top-bck">Swing/d 0.8s</option>
  //     <option value="swing-in-top-bck-15">Swing/d 1.5s</option>
  //     <option value="swing-in-top-bck-20">Swing/d 2.0s</option>
  //     <option value="swing-in-top-bck-30">Swing/d 3.0s</option>
  //     <option value="swing-in-top-bck-40">Swing/d 4.0s</option>

  //     <option value="none">---------------</option>
  //     <option value="scale-in-ver-bottom-05">Scale Bot/d 0.5s</option>
  //     <option value="scale-in-ver-bottom-15">Scale Bot/d 1.5s</option>
  //     <option value="scale-in-ver-bottom-25">Scale Bot/d 2.5s</option>
  //     <option value="scale-in-ver-bottom-35">Scale Bot/d 3.5s</option>

  //     <option value="none">---------------</option>
  //     <option value="scale-in-hor-left-05">Scale V/d 0.5s</option>
  //     <option value="scale-in-hor-left-15">Scale V/d 1.5s</option>
  //     <option value="scale-in-hor-left-25">Scale V/d 2.5s</option>
  //     <option value="scale-in-hor-left-35">Scale V/d 3.5s</option>
