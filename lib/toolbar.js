...
(function () {
  ...
  //     <option value="none">---------------</option>
  //     <option value="slide-in-blurred-left-05">Slide V/d 0.5s</option>
  //     <option value="slide-in-blurred-left-15">Slide V/d 1.5s</option>
  //     <option value="slide-in-blurred-left-25">Slide V/d 2.5s</option>
  //     <option value="slide-in-blurred-left-35">Slide V/d 3.5s</option>
  //     <option value="slide-in-blurred-left-45">Slide V/d 4.5s</option>

  //     <option value="none">---------------</option>
  //     <option value="slide-in-blurred-right-05">Slide H/d 0.5s</option>
  //     <option value="slide-in-blurred-right-15">Slide H/d 1.5s</option>
  //     <option value="slide-in-blurred-right-25">Slide H/d 2.5s</option>
  //     <option value="slide-in-blurred-right-35">Slide H/d 3.5s</option>
  //     <option value="slide-in-blurred-right-45">Slide H/d 4.5s</option>
