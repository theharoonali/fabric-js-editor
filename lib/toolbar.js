...
(function () {
  ...
  <div flow="down">
    ...
    padding: 5px">
      ...
      <option value="0.5" data-attribute="fade">Fade/d 0.5s</option>
      <option value="1.0" data-attribute="fade">Fade/d 1.0s</option>
      <option value="1.5" data-attribute="fade">Fade/d 1.5s</option>
      <option value="2.0" data-attribute="fade">Fade/d 2.0s</option>
      <option value="2.5" data-attribute="fade">Fade/d 2.5s</option>
      <option value="3.0" data-attribute="fade">Fade/d 3.0s</option>
      <option value="3.5" data-attribute="fade">Fade/d 3.5s</option>
      <option value="4.0" data-attribute="fade">Fade/d 4.0s</option>
      
      <option value="none">---------------</option>
      <option value="0.5" data-attribute="scale">Scale/d 0.5s</option>
      <option value="1.0" data-attribute="scale">Scale/d 1.0s</option>
      <option value="1.5" data-attribute="scale">Scale/d 1.5s</option>
      <option value="2.0" data-attribute="scale">Scale/d 2.0s</option>
      <option value="3.0" data-attribute="scale">Scale/d 3.0s</option>
      <option value="4.0" data-attribute="scale">Scale/d 4.0s</option>
      
      <option value="none">---------------</option>
      <option value="0.8" data-attribute="tiltTopV">T-top-V/d 0.8s</option>
      <option value="1.5" data-attribute="tiltTopV">T-top-V/d 1.5s</option>
      <option value="2.5" data-attribute="tiltTopV">T-top-V/d 2.5s</option>
      <option value="3.5" data-attribute="tiltTopV">T-top-V/d 3.5s</option>
      
      <option value="none">---------------</option>
      <option value="0.8" data-attribute="tiltTopH">T-top-H/d 0.8s</option>
      <option value="1.5" data-attribute="tiltTopH">T-top-H/d 1.5s</option>
      <option value="2.5" data-attribute="tiltTopH">T-top-H/d 2.5s</option>
      <option value="3.5" data-attribute="tiltTopH">T-top-H/d 3.5s</option>
      
      <option value="none">---------------</option>
      <option value="0.8" data-attribute="tiltBottomV">Tilt-V/d 0.8s</option>
      <option value="1.5" data-attribute="tiltBottomV">Tilt-V/d 1.5s</option>
      <option value="2.0" data-attribute="tiltBottomV">Tilt-V/d 2.0s</option>
      <option value="3.0" data-attribute="tiltBottomV">Tilt-V/d 3.0s</option>
      <option value="4.8" data-attribute="tiltBottomV">Tilt-V/d 4.0s</option>
      
      <option value="none">---------------</option>
      <option value="0.8" data-attribute="tiltBottomH">Tilt-H/d 0.8s</option>
      <option value="1.5" data-attribute="tiltBottomH">Tilt-H/d 1.5s</option>
      <option value="2.0" data-attribute="tiltBottomH">Tilt-H/d 2.0s</option>
      <option value="3.0" data-attribute="tiltBottomH">Tilt-H/d 3.0s</option>
      <option value="4.0" data-attribute="tiltBottomH">Tilt-H/d 4.0s</option>

      <option value="none">---------------</option>
      <option value="0.8" data-attribute="ScaleVericalTopV">Swing/d 0.8s</option>
      <option value="1.5" data-attribute="ScaleVericalTopV">Swing/d 1.5s</option>
      <option value="2.0" data-attribute="ScaleVericalTopV">Swing/d 2.0s</option>
      <option value="3.0" data-attribute="ScaleVericalTopV">Swing/d 3.0s</option>
      <option value="4.0" data-attribute="ScaleVericalTopV">Swing/d 4.0s</option>
      
      <option value="none">---------------</option>
      <option value="0.5" data-attribute="SlideinLeftV">Slide V/d 0.5s</option>
      <option value="1.5" data-attribute="SlideinLeftV">Slide V/d 1.5s</option>
      <option value="2.5" data-attribute="SlideinLeftV">Slide V/d 2.5s</option>
      <option value="3.5" data-attribute="SlideinLeftV">Slide V/d 3.5s</option>
      <option value="4.5" data-attribute="SlideinLeftV">Slide V/d 4.5s</option>
    
      <option value="none">---------------</option>
      <option value="0.5" data-attribute="SlideinRightV">Slide H/d 0.5s</option>
      <option value="1.5" data-attribute="SlideinRightV">Slide H/d 1.5s</option>
      <option value="2.5" data-attribute="SlideinRightV">Slide H/d 2.5s</option>
      <option value="3.5" data-attribute="SlideinRightV">Slide H/d 3.5s</option>
      <option value="4.5" data-attribute="SlideinRightV">Slide H/d 4.5s</option>
    
      <option value="none">---------------</option>
      <option value="0.5" data-attribute="ScaleVericalBottomV">Scale Bot/d 0.5s</option>
      <option value="1.5" data-attribute="ScaleVericalBottomV">Scale Bot/d 1.5s</option>
      <option value="2.5" data-attribute="ScaleVericalBottomV">Scale Bot/d 2.5s</option>
      <option value="3.5" data-attribute="ScaleVericalBottomV">Scale Bot/d 3.5s</option>
    
      <option value="none">---------------</option>
      <option value="0.5" data-attribute="ScaleHorizontalV">Scale V/d 0.5s</option>
      <option value="1.5" data-attribute="ScaleHorizontalV">Scale V/d 1.5s</option>
      <option value="2.5" data-attribute="ScaleHorizontalV">Scale V/d 2.5s</option>
      <option value="3.5" data-attribute="ScaleHorizontalV">Scale V/d 3.5s</option>
    ...
    try {
      this.containerEl.append(`<div class="topbar" id="topbar">
        ...
        <div class="infohelpvideo">
          <i class="infovideo">?</i> New Editor based on fabric.js
        </div>
        <div tooltip="Download png-sekvens med alpha" flow="down" class="download">
          <a href="#0" class="downloadbtn" id="downloadBtn">SEKVENS</a>
        </div>
        <button tooltip="Download png-fil med alpha" flow="down" class="pngDownload disabled" style="margin-left: 24px">
          STILL
        </button>
        <input class="ifield ifield1" type="text" placeholder="filnavn" required />
        </div>
         <div class="toolbar" id="toolbar"><div class="main-buttons"></div>${selecterAnimation}<div class="extended-buttons"></div></div>`);
