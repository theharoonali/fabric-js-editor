  ...
  var selectionSettings = function () {
    ...
    `);
      ...
      <div class="shadow-section">
        <h4>Shadow</h4>
        <div class="input-container"><label>Color</label><input id="color-picker-shadow" value="black"></div>
        <div class="input-container"><label>Blur</label>50
          <input type="range" value="50" min="0" max="100" id="shadow-blur">
        </div>
        <div class="input-container"><label>OffsetX</label>50
          <input type="range" value="50" min="-100" max="100" id="shadow-offset-x">
        </div>
        <div class="input-container"><label>OffsetY</label>50
          <input type="range" value="50" min="-100" max="100" id="shadow-offset-y">
        </div>
        <hr>
      </div>
    `);
