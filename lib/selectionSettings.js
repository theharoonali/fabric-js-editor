...
(function () {
  ...
  var selectionSettings = function () {
    ...
    (() => {
      ...
      <div class="border-section">
        <h4>Background</h4>
        <div class="input-container"><label>Color</label><input id="color-picker-background" value="black"></div>
    ...
    `);
      ...
      $(`${this.containerSelector} .toolpanel#select-panel .border-section #color-picker-background`).spectrum({
        showButtons: false,
        type: "color",
        showInput: "true",
        allowEmpty: "false",
        move: function (color) {
            let hex = 'transparent';
            if (color) {
                hex = color.toHexString(); // Get hex color string
            }
      ...
      $(`${this.containerSelector} .toolpanel#select-panel .border-section #input-border-padding`).change(function () {
        let padding = parseInt($(this).val()); 
    ...
    $(`${this.containerSelector} .toolpanel#select-panel .border-section #input-border-roundness`).change(function () {
      let a = parseInt($(this).val());
      let activeObjects = _self.canvas.getActiveObjects();
      activeObjects.dirty == true;
      activeObjects.forEach(obj => {
          obj.set({
              rx: a,
              ry: a, 
